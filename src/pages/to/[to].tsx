          ...
          <div className="text-center min-w-[6rem]">
            {organizer.contacts.facebook && (
              <a
                ...
                title={`Scopri ${organizer.name} su Facebook`}
              >
                <svg
                  fill="currentColor"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            {organizer.contacts.discord && (
              <a
                ...
                rel="noreferrer"
                className="text-blue-dark"
                title={`Scopri ${organizer.name} su Discord`}
              >
                <svg
                  fill="currentColor"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            {organizer.contacts.website && (
              <a
                ...
                className="text-blue-dark"
                rel="noreferrer"
                title={`Visita il sito di ${organizer.name}`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="inline-block h-6 w-6"
            ...
            {organizer.contacts.whatsapp && (
              <a
                ...
                rel="noreferrer"
                className="text-blue-dark"
                title={`Contatta ${organizer.name} su Whatsapp`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="inline-block h-6 w-6"
